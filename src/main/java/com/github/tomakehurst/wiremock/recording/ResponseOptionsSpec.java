...
/**
 * Encapsulates options for generating the ResponseDefinition in StubMappings
 */
public class ResponseOptionsSpec {
    // Criteria for extracting body from responses
    private final ResponseDefinitionBodyMatcher extractBodyCriteria;

    @JsonCreator
    public ResponseOptionsSpec(@JsonProperty("extractBodyCriteria") ResponseDefinitionBodyMatcher extractBodyCriteria) {
